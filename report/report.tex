...
\begin{document}
    ...
    % nächster Punkt bei Interpolanten, dabei gesucht: minimale PunktabstandssummeWir wollen ein Dreieck aus drei Datenpunkten, $c, c_1$ und $c_2$ um einen Punkt $p$ legen.
