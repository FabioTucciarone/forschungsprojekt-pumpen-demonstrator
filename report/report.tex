...
\begin{document}
    ...
    Mit den blauen Pfeilen sind die Kommunikationspfade für die Anfragen an das Modell beschrieben. \todo{Struktur verbessern}
    ...
    \todo{Fortsetzen, Bild positionieren}
